...
Shared skills live in `.agents/skills/`. Claude links to them from its package, and Grok reads them through `[skills].paths` in `packages/common/grok/.grok/config.toml`.
