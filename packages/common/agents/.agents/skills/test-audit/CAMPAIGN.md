...
own list: in the Telegram campaign, all three were real delivery bugs, not stale
tests.
...
keeper instead, and confirm every new regression from the default branch still
