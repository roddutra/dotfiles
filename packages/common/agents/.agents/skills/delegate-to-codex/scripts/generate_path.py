#!/usr/bin/env python3
"""Generate correctly formatted file paths for a Codex delegation round.
...
Directory structure:
  ~/.codex-delegate/<project>/<YYYY-MM-DD>/<HHMMSS-title>/
    session.json
    r1-brief.md
    r1-report.md
"""
...
DELEGATE_DIR = Path.home() / ".codex-delegate"
...
def main():
    parser = argparse.ArgumentParser(description="Generate Codex delegation file paths for a round")
